...
public class ActionCheckin extends AsyncAction {

	public ActionCheckin(String token, IActionListener actionListener, ConvertJSON converter, EntityKey location) {
		super(AsyncActionType.CHECKIN, AsyncActionCategory.MODIFY_CHALLENGE, actionListener, converter, location);
		urlBuilder.addUrlPath("api/checkin/" + location.getKey() + "/");
